...
class MailHome extends React.Component {
  ...
  onSelectProfile = profile => () => {
    this.props.history.push(`/mail/login?profile=${profile}`);
  };
                ...
                <Grid.Column>
                  <Grid.Row>
                    <Grid.Column>
                      ...
                      <Link to='/mail/existing' className='ui coral button'>
                        Import Wallet
                      </Link>
                    </Grid.Column>
                  </Grid.Row>
                  ...
                  <Grid.Row>
                    <Grid.Column>
                      ...
                      <Link to='/mail/new' className='ui coral button'>
                        Create a Wallet
                      </Link>
                    </Grid.Column>
                  </Grid.Row>
...
export default withRouter(connect(mapStateToProps)(MailHome));
