...
if (((localStorage.getItem("username")==undefined) || (localStorage.getItem("password")==undefined)) || ((localStorage.getItem("hostname")==undefined) || (localStorage.getItem("port")==undefined)) || (((localStorage.getItem("username")=='') || (localStorage.getItem("password")=='')) || ((localStorage.getItem("hostname")=='') || (localStorage.getItem("port")=='')))) {
  authprompt();
  authlistener('');
...
function httpsauth(){
  sendcredentials = '{ "username":"'+localStorage.getItem("username")+'", "password":"'+localStorage.getItem("password")+'"}';
  soptions = {
