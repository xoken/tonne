...
function authlistener(msg) {
  ...
  document
    .getElementById("submitcredentials")
    .addEventListener("click", function () {
      authmessageinput.innerHTML =
        "<div style='padding:15px;color:red;font-weight: bold;'>" +
        msg +
        "</div>";
      if (
        usernameinput.value == "" ||
        ...
        authmessageinput.innerHTML =
          "<div style='padding:15px;color:red;font-weight: bold;'>One or more fields are empty</div>";
      } else {
