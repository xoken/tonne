...
class ExistingWallet extends React.Component {
  ...
  mix = () => {
    ...
    for (var i = 0; i < this.alphabetarray.length; i++) {
      if (this.counter === this.alphabetarray.length * 20) {
        this.printalphabets(this.alphabetarray);
        break;
      }
  ...
  letteraddlistener = () => {
    ...
    for (var c = 0; c < letters.length; c++) {
      letters[c].addEventListener('click', () => {
        document.getElementById('mnemonic').textContent += this.textContent;
  ...
  wordsuggest = (len, cont) => {
    ...
    if (len !== 0) {
      ...
      if (count <= 36) {
        document.getElementById('suggestions').innerHTML += tempsuggestion;
      }
    }
    this.wordaddlistener();
  };
  ...
  wordaddlistener = () => {
    ...
    for (var d = 0; d < wordlist.length; d++) {
      wordlist[d].addEventListener('click', () => {
        tempmnemonic = document.getElementById('mnemonic').textContent;
