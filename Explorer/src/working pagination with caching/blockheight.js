...
var result;
var fullresp='';
var sessionflag=0,dataflag=1;
var firstfourbytes=0;
var sessionresponse,sessionresponseflag=0;
var rresponseflag=0;
var sbuffer='',rbuffer='';
...
if ((pagearray[pagearrlength-1]==numofdisplayedpages) && (txfinished==0)) {
  httpsreq('Bearer '+localStorage.getItem("sessionkey")+'','v1/block/txids/'+currentblockhash+'/?pagenumber='+serverpagenumber+'&pagesize=50','updatepaginationarray');
}
else{
  currentbatchnum+=1;
  //console.log(currentbatchnum);
