...
async function createRollupConfig(opts, outputNum) {
    ...
    return {
        ...
        output: {
            ...
            esModule: Boolean((_a = tsCompilerOptions) === null || _a === void 0 ? void 0 : _a.esModuleInterop),
        ...
        plugins: [
            ...
            rollup_plugin_typescript2_1.default({
                ...
                useTsconfigDeclarationDir: Boolean((_b = tsCompilerOptions) === null || _b === void 0 ? void 0 : _b.declarationDir),
            }),
