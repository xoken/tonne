...
import { bip32, ECPair, payments, networks, Psbt } from 'bitcoinjs-lib';
import AES from 'crypto-js/aes';
import coinSelect from 'coinselect';
import faker from 'faker';
import { mnemonicToSeed, mnemonicToSeedSync, generateMnemonic } from 'bip39';
...
var Utils = /*#__PURE__*/function () {
  function Utils() {
    this.mnemonicToSeed = function (bip39Mnemonic, password) {
      try {
        return Promise.resolve(mnemonicToSeed(bip39Mnemonic, password));
      } catch (e) {
        return Promise.reject(e);
      }
    };
...
var Wallet = /*#__PURE__*/function () {
  function Wallet() {
    this.getBIP32ExtendedPrivKey = function (bip32ExtendedKey) {
      var bip32Interface = bip32.fromBase58(bip32ExtendedKey, network.BITCOIN_SV_REGTEST);
      var xprvkeyB58 = 'NA';
  ...
  _proto._mnemonicToSeedSync = function _mnemonicToSeedSync(bip39Mnemonic, password) {
    return mnemonicToSeedSync(bip39Mnemonic, password);
  };
  ...
  _proto._getBIP32ExtendedKey = function _getBIP32ExtendedKey(path, bip32RootKey) {
    ...
    var extendedKey = bip32.fromBase58(bip32RootKey, network.BITCOIN_SV_REGTEST);
  ...
  _proto._generateDerivedKeys = function _generateDerivedKeys(bip32ExtendedKey, derivationPath, index, useBip38, bip38password, useHardenedAddresses) {
    ...
    var keyPair = ECPair.fromPrivateKey(key.privateKey, {
  ...
  _proto._getTransactions = function _getTransactions(txIds) {
    try {
      var chunkedTxIds = chunk(txIds, 20);
  ...
  _proto._getOutputs = function _getOutputs(derivedKeys, prevDiffOutputs, prevKeys) {
    ...
    try {
      ...
      var chunkedUsedDerivedKeys = chunk(derivedKeys, 20);
                          ...
                          var _temp17 = function () {
                            if (unconfirmedTransactions.length > 0) {
                              ...
                              var _temp21 = _forTo(unconfirmedTransactions, function (index) {
                                ...
                                var diffInMinutes = differenceInMinutes(new Date(), Date.parse(unconfirmedTransaction.createdAt));
  ...
  _proto.generateMnemonic = function generateMnemonic$1(strength, rng, wordlist) {
  ...
  _proto.getUsedAddresses = function getUsedAddresses() {
    try {
      return Promise.resolve(getOutputs()).then(function (_ref30) {
        ...
        var outputsGroupedByAddress = groupBy(outputs, function (output) {
...
export { addressAPI, allPay, Allegory$1 as allegory, authAPI, blockAPI, chainAPI, derivationPaths$1 as derivationPaths, httpClient, merkleBranchAPI, network$1 as network, Persist as persist, scriptHashAPI, transactionAPI, userAPI, utils, wallet };
//# sourceMappingURL=nipkow-sdk.esm.js.map
